...
const Home = () => {
    ...
    return (
        ...
        <div id="greeting">
            <div>
                <h2>Hi, I'm Mike.</h2> I am, among many things, a husband, father, woodworker, umpire, gamer, and all-round explorer. I love to try new things, and I'll give <em>(almost)</em> anything a try.
            ...
            <div>
                <img id="portrait" src="../src/assets/NC-Mike.jpg" alt="Mike Sealey"/>
            </div>
        </div>
